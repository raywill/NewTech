...
//
/*
默认动画的渐变频率是线性，即LinearInterpolator，该类实现了Interpolator接口。
其实Interpolator是一个接口类，有很多实现类，如AccelerateDecelerateInterpolator, 
...
具体可以查看官方文档http://developer.android.com/reference/android/view/animation/Interpolator.html 
我们可以使用animation.setInterpolator(interpolator)的方式为动画设置渐变频率。
本Demo中统一用的是LinearInterpolator。
http://www.eoeandroid.com/forum.php?mod=viewthread&tid=194772
 */
package com.xgb.animations.customize;
